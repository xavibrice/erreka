...
/**
 * @ORM\Entity(repositoryClass="App\Repository\TypeLocalRepository")
 */
class TypeLocal
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RateHousing", mappedBy="type_local")
     */
    private $rateHousings;

    /**
     * @ORM\OneToMany(targetEntity=Client::class, mappedBy="type_local")
     */
    private $clients;
    ...
    public function removeRateHousing(RateHousing $rateHousing): self
    {
        if ($this->rateHousings->contains($rateHousing)) {
            ...
            if ($rateHousing->getTypeLocal() === $this) {
                $rateHousing->setTypeLocal(null);
            }
        }
    ...
    public function removeClient(Client $client): self
    {
        if ($this->clients->contains($client)) {
            ...
            // set the owning side to null (unless already changed)
            if ($client->getTypeLocal() === $this) {
                $client->setTypeLocal(null);
            }
        }
