...
/**
 * @ORM\Entity(repositoryClass="App\Repository\WindowRepository")
 */
class Window
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RateHousing", mappedBy="window")
     */
    ...
    public function removeRateHousing(RateHousing $rateHousing): self
    {
        if ($this->rateHousings->contains($rateHousing)) {
            ...
            if ($rateHousing->getWindow() === $this) {
                $rateHousing->setWindow(null);
            }
        }
