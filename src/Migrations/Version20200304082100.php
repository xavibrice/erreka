 ...
 */
final class Version20200304082100 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, agency_id INT DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(150) NOT NULL, image_filename VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, mobile VARCHAR(255) DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649CDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, street_id INT DEFAULT NULL, reason_id INT DEFAULT NULL, type_property_id INT DEFAULT NULL, commercial_id INT DEFAULT NULL, rate_housing_id INT DEFAULT NULL, historical_id INT DEFAULT NULL, agency_id INT DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, price NUMERIC(10, 0) DEFAULT NULL, enabled TINYINT(1) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, created DATE NOT NULL, portal VARCHAR(255) DEFAULT NULL, floor VARCHAR(255) DEFAULT NULL, url LONGTEXT DEFAULT NULL, reference CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', phone VARCHAR(255) DEFAULT NULL, next_call DATE DEFAULT NULL, INDEX IDX_8BF21CDE87CF8EB (street_id), INDEX IDX_8BF21CDE59BB1592 (reason_id), INDEX IDX_8BF21CDE1F8BC47D (type_property_id), INDEX IDX_8BF21CDE7854071C (commercial_id), INDEX IDX_8BF21CDE7F339F8 (rate_housing_id), INDEX IDX_8BF21CDEC75EAE06 (historical_id), INDEX IDX_8BF21CDECDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE note_client (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, comment LONGTEXT NOT NULL, created DATETIME NOT NULL, INDEX IDX_DF96538119EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offered (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, property_id INT DEFAULT NULL, created DATE DEFAULT NULL, INDEX IDX_21950C7419EB6921 (client_id), INDEX IDX_21950C74549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE property ADD CONSTRAINT FK_8BF21CDECDEADB2A FOREIGN KEY (agency_id) REFERENCES agency (id)');
        ...
        $this->addSql('ALTER TABLE note_client ADD CONSTRAINT FK_DF96538119EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP FOREIGN KEY FK_8BF21CDECDEADB2A');
        ...
        $this->addSql('ALTER TABLE note_client DROP FOREIGN KEY FK_DF96538119EB6921');
        ...
        $this->addSql('DROP TABLE note_client');
