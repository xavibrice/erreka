 ...
 */
final class Version20191211084535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL, CHANGE price_actual price_actual NUMERIC(10, 0) DEFAULT NULL');
