 ...
 */
final class Version20191023081950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_21430D22520F822 ON rate_housing (heating_id)');
        $this->addSql('CREATE INDEX IDX_21430D2281091F4D ON rate_housing (window_id)');
