 ...
 */
final class Version20191220113233 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client_zone (client_id INT NOT NULL, zone_id INT NOT NULL, INDEX IDX_7177036519EB6921 (client_id), INDEX IDX_717703659F2C3FAB (zone_id), PRIMARY KEY(client_id, zone_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE client_zone ADD CONSTRAINT FK_7177036519EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE client_zone ADD CONSTRAINT FK_717703659F2C3FAB FOREIGN KEY (zone_id) REFERENCES zone (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE client_zone');
