 ...
 */
final class Version20191014073806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property_reduction (id INT AUTO_INCREMENT NOT NULL, property_id INT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, INDEX IDX_C00856D5549213EC (property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
