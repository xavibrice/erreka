 ...
 */
final class Version20191122115417 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD color VARCHAR(255) DEFAULT NULL, ADD text_color VARCHAR(255) DEFAULT NULL, CHANGE commercial_id commercial_id INT DEFAULT NULL, CHANGE end_at end_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP color, DROP text_color, CHANGE commercial_id commercial_id INT DEFAULT NULL, CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
