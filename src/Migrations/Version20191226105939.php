 ...
 */
final class Version20191226105939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offered ADD property_id INT DEFAULT NULL, CHANGE created created DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offered DROP property_id, CHANGE created created DATE DEFAULT \'NULL\'');
