 ...
 */
final class Version20200110145052 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proposal (id INT AUTO_INCREMENT NOT NULL, property_id INT DEFAULT NULL, client_id INT DEFAULT NULL, price NUMERIC(10, 0) NOT NULL, agree TINYINT(1) DEFAULT NULL, contract DATE DEFAULT NULL, scriptures DATE DEFAULT NULL, INDEX IDX_BFE59472549213EC (property_id), INDEX IDX_BFE5947219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
