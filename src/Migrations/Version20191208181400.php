 ...
 */
final class Version20191208181400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE exclusive (id INT AUTO_INCREMENT NOT NULL, comment LONGTEXT DEFAULT NULL, house_key TINYINT(1) NOT NULL, price NUMERIC(10, 0) DEFAULT NULL, price_ok NUMERIC(10, 0) DEFAULT NULL, price_actual NUMERIC(10, 0) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
