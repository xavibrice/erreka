 ...
 */
final class Version20200110173304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wall DROP FOREIGN KEY FK_13F5EFF67F339F8');
        $this->addSql('DROP INDEX IDX_13F5EFF67F339F8 ON wall');
        $this->addSql('ALTER TABLE wall DROP rate_housing_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE visit CHANGE property_id property_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE visited visited DATE DEFAULT \'NULL\', CHANGE price price NUMERIC(10, 0) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE wall ADD rate_housing_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE wall ADD CONSTRAINT FK_13F5EFF67F339F8 FOREIGN KEY (rate_housing_id) REFERENCES rate_housing (id)');
        $this->addSql('CREATE INDEX IDX_13F5EFF67F339F8 ON wall (rate_housing_id)');
        $this->addSql('ALTER TABLE zone CHANGE agency_id agency_id INT DEFAULT NULL');
    }
}
