 ...
 */
final class Version20191007103815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rate_housing ADD been_cooking_id INT DEFAULT NULL, ADD windows_state_id INT DEFAULT NULL, ADD been_walls_id INT DEFAULT NULL, ADD doors_state_id INT DEFAULT NULL, ADD ground_state_id INT DEFAULT NULL, CHANGE new_id new_id INT DEFAULT NULL, CHANGE bathroom_state_id bathroom_state_id INT DEFAULT NULL, CHANGE min_price min_price NUMERIC(10, 2) DEFAULT NULL, CHANGE max_price max_price NUMERIC(10, 2) DEFAULT NULL, CHANGE bedrooms bedrooms INT DEFAULT NULL, CHANGE bathrooms bathrooms INT DEFAULT NULL, CHANGE approx_meters approx_meters INT DEFAULT NULL, CHANGE real_meters real_meters INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_21430D22394F640 ON rate_housing (been_cooking_id)');
        $this->addSql('CREATE INDEX IDX_21430D222ED4DF49 ON rate_housing (windows_state_id)');
        $this->addSql('CREATE INDEX IDX_21430D22DA462B74 ON rate_housing (been_walls_id)');
        $this->addSql('CREATE INDEX IDX_21430D2241AE3D41 ON rate_housing (doors_state_id)');
        $this->addSql('CREATE INDEX IDX_21430D228738B342 ON rate_housing (ground_state_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_21430D22394F640 ON rate_housing');
        $this->addSql('DROP INDEX IDX_21430D222ED4DF49 ON rate_housing');
        $this->addSql('DROP INDEX IDX_21430D22DA462B74 ON rate_housing');
        $this->addSql('DROP INDEX IDX_21430D2241AE3D41 ON rate_housing');
        $this->addSql('DROP INDEX IDX_21430D228738B342 ON rate_housing');
        $this->addSql('ALTER TABLE rate_housing DROP been_cooking_id, DROP windows_state_id, DROP been_walls_id, DROP doors_state_id, DROP ground_state_id, CHANGE new_id new_id INT DEFAULT NULL, CHANGE bathroom_state_id bathroom_state_id INT DEFAULT NULL, CHANGE min_price min_price NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE max_price max_price NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE bedrooms bedrooms INT DEFAULT NULL, CHANGE bathrooms bathrooms INT DEFAULT NULL, CHANGE approx_meters approx_meters INT DEFAULT NULL, CHANGE real_meters real_meters INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reason CHANGE situation_id situation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE street CHANGE zone_id zone_id INT DEFAULT NULL');
