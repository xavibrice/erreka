 ...
 */
final class Version20191211170210 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge DROP comment, DROP price_actual, CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD comment LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD price_actual NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT \'NULL\'');
