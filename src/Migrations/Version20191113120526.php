 ...
 */
final class Version20191113120526 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD heating_id INT DEFAULT NULL, ADD orientation_id INT DEFAULT NULL, ADD real_meters INT DEFAULT NULL, ADD bedrooms INT DEFAULT NULL, ADD bathrooms INT DEFAULT NULL, ADD terrace TINYINT(1) DEFAULT NULL, ADD suit_bathroom TINYINT(1) DEFAULT NULL, ADD direct_garage TINYINT(1) DEFAULT NULL, ADD video_intercom TINYINT(1) DEFAULT NULL, ADD storage_room TINYINT(1) DEFAULT NULL, ADD disabled_access TINYINT(1) DEFAULT NULL, ADD zero_dimension TINYINT(1) DEFAULT NULL, ADD elevator TINYINT(1) DEFAULT NULL, CHANGE price price NUMERIC(10, 2) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE mobile mobile VARCHAR(255) DEFAULT NULL, CHANGE created created DATE DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_C7440455520F822 ON client (heating_id)');
        $this->addSql('CREATE INDEX IDX_C74404555545372F ON client (orientation_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C7440455520F822 ON client');
        $this->addSql('DROP INDEX IDX_C74404555545372F ON client');
        $this->addSql('ALTER TABLE client DROP heating_id, DROP orientation_id, DROP real_meters, DROP bedrooms, DROP bathrooms, DROP terrace, DROP suit_bathroom, DROP direct_garage, DROP video_intercom, DROP storage_room, DROP disabled_access, DROP zero_dimension, DROP elevator, CHANGE price price NUMERIC(10, 2) DEFAULT \'NULL\', CHANGE email email VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE mobile mobile VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE created created DATE DEFAULT \'NULL\'');
