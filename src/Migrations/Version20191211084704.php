 ...
 */
final class Version20191211084704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD charge_type_id INT DEFAULT NULL, CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL, CHANGE price_actual price_actual NUMERIC(10, 0) DEFAULT NULL');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA43491A77836 FOREIGN KEY (charge_type_id) REFERENCES charge_type (id)');
        $this->addSql('CREATE INDEX IDX_556BA43491A77836 ON charge (charge_type_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_556BA43491A77836 ON charge');
        $this->addSql('ALTER TABLE charge DROP charge_type_id, CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE price_actual price_actual NUMERIC(10, 0) DEFAULT \'NULL\'');
