 ...
 */
final class Version20190930095608 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD title VARCHAR(255) NOT NULL, CHANGE sub_category_id sub_category_id INT DEFAULT NULL');
