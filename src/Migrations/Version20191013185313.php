 ...
 */
final class Version20191013185313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zone ADD agency_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE zone ADD CONSTRAINT FK_A0EBC007CDEADB2A FOREIGN KEY (agency_id) REFERENCES agency (id)');
        $this->addSql('CREATE INDEX IDX_A0EBC007CDEADB2A ON zone (agency_id)');
        ...
        $this->addSql('ALTER TABLE agency DROP FOREIGN KEY FK_70C0C6E69F2C3FAB');
        $this->addSql('DROP INDEX IDX_70C0C6E69F2C3FAB ON agency');
        $this->addSql('ALTER TABLE agency DROP zone_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agency ADD zone_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE agency ADD CONSTRAINT FK_70C0C6E69F2C3FAB FOREIGN KEY (zone_id) REFERENCES zone (id)');
        $this->addSql('CREATE INDEX IDX_70C0C6E69F2C3FAB ON agency (zone_id)');
        $this->addSql('ALTER TABLE booking CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('DROP INDEX IDX_A0EBC007CDEADB2A ON zone');
        $this->addSql('ALTER TABLE zone DROP agency_id');
    }
}
