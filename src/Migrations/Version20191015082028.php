 ...
 */
final class Version20191015082028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE state (id INT AUTO_INCREMENT NOT NULL, type_state_id INT DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, full_name VARCHAR(255) NOT NULL, INDEX IDX_A393D2FBC8271B3D (type_state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_state (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE state DROP FOREIGN KEY FK_A393D2FBC8271B3D');
