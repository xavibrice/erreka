 ...
 */
final class Version20191013191340 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, street_id INT DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, INDEX IDX_8BF21CDE87CF8EB (street_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
