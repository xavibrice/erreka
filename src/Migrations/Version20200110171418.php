 ...
 */
final class Version20200110171418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD state_keys_id INT DEFAULT NULL, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL, CHANGE expiration_date expiration_date DATE DEFAULT NULL, CHANGE end_date end_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE charge ADD CONSTRAINT FK_556BA4341ECCB2C0 FOREIGN KEY (state_keys_id) REFERENCES state_keys (id)');
        $this->addSql('CREATE INDEX IDX_556BA4341ECCB2C0 ON charge (state_keys_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_556BA4341ECCB2C0 ON charge');
        $this->addSql('ALTER TABLE charge DROP state_keys_id, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE expiration_date expiration_date DATE DEFAULT \'NULL\', CHANGE end_date end_date DATE DEFAULT \'NULL\'');
