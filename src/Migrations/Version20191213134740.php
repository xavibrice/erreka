 ...
 */
final class Version20191213134740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE state_keys (id INT AUTO_INCREMENT NOT NULL, rate_housing_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_206DCD2A7F339F8 (rate_housing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
