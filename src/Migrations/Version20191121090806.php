 ...
 */
final class Version20191121090806 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD commercial_id INT DEFAULT NULL, CHANGE end_at end_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE7854071C FOREIGN KEY (commercial_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDE7854071C ON booking (commercial_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E00CEDDE7854071C ON booking');
        $this->addSql('ALTER TABLE booking DROP commercial_id, CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
