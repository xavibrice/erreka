 ...
 */
final class Version20190930095420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP title, CHANGE sub_category_id sub_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD title VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE sub_category_id sub_category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE booking CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
