 ...
 */
final class Version20191122115735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD description LONGTEXT DEFAULT NULL, CHANGE commercial_id commercial_id INT DEFAULT NULL, CHANGE end_at end_at DATETIME DEFAULT NULL, CHANGE color color VARCHAR(255) DEFAULT NULL, CHANGE text_color text_color VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP description, CHANGE commercial_id commercial_id INT DEFAULT NULL, CHANGE end_at end_at DATETIME DEFAULT \'NULL\', CHANGE color color VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE text_color text_color VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
