 ...
 */
final class Version20200106164824 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_556BA434549213EC ON charge');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_556BA434549213EC ON charge (property_id)');
