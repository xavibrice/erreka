 ...
 */
final class Version20191226105732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offered (id INT AUTO_INCREMENT NOT NULL, comment LONGTEXT DEFAULT NULL, price LONGTEXT DEFAULT NULL, created DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
