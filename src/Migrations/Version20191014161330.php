 ...
 */
final class Version20191014161330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note_new ADD property_id INT DEFAULT NULL, CHANGE new_id new_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE note_new ADD CONSTRAINT FK_1B1064A5549213EC FOREIGN KEY (property_id) REFERENCES property (id)');
        $this->addSql('CREATE INDEX IDX_1B1064A5549213EC ON note_new (property_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_1B1064A5549213EC ON note_new');
        $this->addSql('ALTER TABLE note_new DROP property_id, CHANGE new_id new_id INT DEFAULT NULL');
