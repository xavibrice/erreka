 ...
 */
final class Version20191230181658 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note_new CHANGE property_id property_id INT DEFAULT NULL, CHANGE notice_date notice_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note_commercial CHANGE commercial_id commercial_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE note_new CHANGE property_id property_id INT DEFAULT NULL, CHANGE notice_date notice_date DATE NOT NULL');
        $this->addSql('ALTER TABLE offered CHANGE property_id property_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE created created DATE DEFAULT \'NULL\'');
