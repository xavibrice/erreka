 ...
 */
final class Version20191227172738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge ADD start_date DATE NOT NULL, ADD end_date DATE DEFAULT NULL, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL, CHANGE expiration_date expiration_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge DROP start_date, DROP end_date, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT \'NULL\', CHANGE expiration_date expiration_date DATE DEFAULT \'NULL\'');
