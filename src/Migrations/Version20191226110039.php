 ...
 */
final class Version20191226110039 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offered ADD client_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL, CHANGE created created DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE offered ADD CONSTRAINT FK_21950C7419EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_21950C7419EB6921 ON offered (client_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_21950C7419EB6921 ON offered');
        $this->addSql('ALTER TABLE offered DROP client_id, CHANGE property_id property_id INT DEFAULT NULL, CHANGE created created DATE DEFAULT \'NULL\'');
