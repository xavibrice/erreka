 ...
 */
final class Version20191114091841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type_property DROP name_slug, DROP template');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reason CHANGE situation_id situation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE street CHANGE zone_id zone_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_property ADD name_slug VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD template INT NOT NULL');
