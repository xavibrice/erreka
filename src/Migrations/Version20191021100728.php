 ...
 */
final class Version20191021100728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD email VARCHAR(255) DEFAULT NULL, ADD mobile VARCHAR(255) DEFAULT NULL, ADD comment LONGTEXT DEFAULT NULL, ADD created DATE DEFAULT NULL, CHANGE price price NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE client DROP email, DROP mobile, DROP comment, DROP created, CHANGE price price NUMERIC(10, 2) DEFAULT \'NULL\'');
