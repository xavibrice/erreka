 ...
 */
final class Version20191014144913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property_reduction ADD reduction_date DATE NOT NULL, ADD reduction_next_date DATE DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL');
