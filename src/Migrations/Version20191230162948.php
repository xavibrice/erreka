 ...
 */
final class Version20191230162948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE images ADD rate_housing_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL, CHANGE name_image name_image VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE images ADD CONSTRAINT FK_E01FBE6A7F339F8 FOREIGN KEY (rate_housing_id) REFERENCES rate_housing (id)');
        $this->addSql('CREATE INDEX IDX_E01FBE6A7F339F8 ON images (rate_housing_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_E01FBE6A7F339F8 ON images');
        $this->addSql('ALTER TABLE images DROP rate_housing_id, CHANGE property_id property_id INT DEFAULT NULL, CHANGE name_image name_image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE note_commercial CHANGE commercial_id commercial_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE note_new CHANGE property_id property_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE offered CHANGE property_id property_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE created created DATE DEFAULT \'NULL\'');
