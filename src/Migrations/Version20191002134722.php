 ...
 */
final class Version20191002134722 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE news DROP INDEX IDX_1DD399507F339F8, ADD UNIQUE INDEX UNIQ_1DD399507F339F8 (rate_housing_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE news DROP INDEX UNIQ_1DD399507F339F8, ADD INDEX IDX_1DD399507F339F8 (rate_housing_id)');
