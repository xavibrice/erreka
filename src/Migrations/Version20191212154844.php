 ...
 */
final class Version20191212154844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE situation DROP name_slug');
        ...
        $this->addSql('ALTER TABLE charge CHANGE rate_housing_id rate_housing_id INT DEFAULT NULL, CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL');
        $this->addSql('ALTER TABLE energy_certificate CHANGE name name VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE property_reduction CHANGE property_id property_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) NOT NULL, CHANGE reduction_next_date reduction_next_date DATE DEFAULT NULL, CHANGE last_price last_price NUMERIC(10, 0) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property_reduction CHANGE property_id property_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 2) NOT NULL, CHANGE reduction_next_date reduction_next_date DATE DEFAULT \'NULL\', CHANGE last_price last_price NUMERIC(10, 2) NOT NULL');
        ...
        $this->addSql('ALTER TABLE reason CHANGE situation_id situation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE situation ADD name_slug VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE street CHANGE zone_id zone_id INT DEFAULT NULL');
