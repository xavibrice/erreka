 ...
 */
final class Version20191116000241 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property_client (property_id INT NOT NULL, client_id INT NOT NULL, INDEX IDX_B9336B2919EB6921 (client_id), INDEX IDX_B9336B29549213EC (property_id), PRIMARY KEY(property_id, client_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
