 ...
 */
final class Version20190930163409 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reason ADD situation_id INT DEFAULT NULL, DROP news_id');
        ...
        $this->addSql('ALTER TABLE news CHANGE commercial_id commercial_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 2) DEFAULT NULL, CHANGE first_name first_name VARCHAR(255) DEFAULT NULL, CHANGE last_name last_name VARCHAR(255) DEFAULT NULL, CHANGE mobile mobile VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE portal portal VARCHAR(255) DEFAULT NULL, CHANGE floor floor VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE situation DROP FOREIGN KEY FK_EC2D9ACA59BB1592');
        $this->addSql('DROP INDEX IDX_EC2D9ACA59BB1592 ON situation');
        $this->addSql('ALTER TABLE situation DROP reason_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE situation ADD reason_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE situation ADD CONSTRAINT FK_EC2D9ACA59BB1592 FOREIGN KEY (reason_id) REFERENCES reason (id)');
        $this->addSql('CREATE INDEX IDX_EC2D9ACA59BB1592 ON situation (reason_id)');
