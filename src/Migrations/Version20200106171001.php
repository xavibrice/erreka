 ...
 */
final class Version20200106171001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE charge CHANGE charge_type_id charge_type_id INT DEFAULT NULL, CHANGE property_id property_id INT DEFAULT NULL, CHANGE price price NUMERIC(10, 0) DEFAULT NULL, CHANGE price_ok price_ok NUMERIC(10, 0) DEFAULT NULL, CHANGE expiration_date expiration_date DATE DEFAULT NULL, CHANGE end_date end_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE property DROP FOREIGN KEY FK_8BF21CDE55284914');
        $this->addSql('DROP INDEX UNIQ_8BF21CDE55284914 ON property');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8BF21CDE55284914 ON property (charge_id)');
        $this->addSql('ALTER TABLE property_reduction CHANGE property_id property_id INT DEFAULT NULL, CHANGE reduction_next_date reduction_next_date DATE DEFAULT \'NULL\'');
